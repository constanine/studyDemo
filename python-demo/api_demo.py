...
def test_getRightCellValue():
   ...
   print("doc,"+api_wlx.getRightCellValue("D:/work/GIT_WORK/studyDemo/python-demo/resources/api-demo/test-A.doc", 0, 0, "葡萄"));
...
def test_getManualCellValue():
   ...
   print("doc,"+api_wlx.getManualCellValue("D:/work/GIT_WORK/studyDemo/python-demo/resources/api-demo/test-A.doc", 1, 0, 2, "葡萄"));
...
print("doc," + api_wlx.findCodeVal("D:/work/GIT_WORK/studyDemo/python-demo/resources/api-demo/test-A.doc", 1, 0, "数量", "葡萄"));